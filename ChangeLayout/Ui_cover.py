...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        #self.searchBtn.setObjectName("pushButton_n")
        #self.serchBtn=QtWidgets.QPushButton()
...
class Winform(QWidget):
    ...
    def paintEvent(self, event):
        ...
        pixmap=QPixmap("./images/gaokao.jpg")
...
if __name__ == "__main__":
    ...
    #Form.setStyleSheet("#MainWindow{border-image:url(images/gaokao.jpg);}")
    #Form.setPalette(palette)
    #palette.drawPixmap(Form.rect(), QPixmap("./images/gaokao.jpg"))
    #Form.setPaletteixmap(QPixmap("./images/gaokao.jpg"))
    palette=QPalette()
    palette.setColor(QPalette.Background, QColor(202, 216, 235))
    Form.setPalette(palette)
    #palette.setBrush(QPalette.Background, QBrush(QPixmap("./images/gaokao1.jpg")))
    #Form.setPalette(palette)
